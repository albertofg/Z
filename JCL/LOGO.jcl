...
*              NEXT ELEVEN LINES DISPLAYS LOGOs
         ...
         DC C'            Bienvenido a Albertit0 Mainf'
         DC C'rame System                             '
...
*        SPACE
CICSTS53 USSCMD  CMD=CICSTS53,REP=LOGON,FORMAT=BAL
         USSPARM PARM=APPLID,DEFAULT=CICSTS53
CICSTS54 USSCMD  CMD=CICSTS54,REP=LOGON,FORMAT=BAL
...
*        SCREEN MSG=04,TEXT='Parameter with value is invalid'
         ...
         END
/*
//L.SYSLMOD DD DISP=SHR,DSN=USER.Z23A.VTAMLIB
//L.SYSIN   DD *
  NAME USSS(R)
//*